...
def home2(request):
"""!@ 	Creates the render request for home2.html, which is the main page of Submission History. 
			This includes validating log ins, and reading results from the user's submission within TLS.
"""
