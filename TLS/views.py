...
def Form(request):
"""!@ 	Creates the input form for TLS, allowing the teachers to upload thier lesson plans. 
			Checks the file validity, the user, saves the document locally, and counts the amount of files being uploaded.
"""
...
def stem(word):
"""!@ Stems the words found in both the uploaded lesson plans and the Nebraska State Standards.
"""
...
"""!@ Tokenizes the key words found within the uploaded lesson plans and the Nebraska State Standards.
"""
...
"""!@ Searches for the key words tokenized in the concordance method.
"""
...
"""!@ Remoes all special cases and characters from the uploaded lesson plan and the Nebraska State Standard.
"""
...
def home11(request):
"""!@ 	Creates the render for home11.html, the main page for TLS. 
			This is also where the main work to match up the lesson plan against the Nebraska State Standard.
"""
